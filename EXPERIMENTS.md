...
Updated 2026-09-11. **Zero scientific experiments completed.** Static data/schema and source audits are recorded separately. Proposed IDs are stable; never recycle an ID for a different hypothesis.
...
| EXP-002 | [Fixed-wiring adaptive headroom](experiments/EXP-002.md) | proposed / specified | R02; target resource measurement | Feedback minus reward-only; validate equation traces and task chronology |
