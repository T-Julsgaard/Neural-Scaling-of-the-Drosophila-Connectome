...
from .engine import execute_block
...
def freeze(stage):
    ...
    design = {'protocol': 'EXP-004-1.0', 'stage': stage, 'blocks': list(STAGES[stage][1]),
              'seed_root': 4, 'conditions_per_block': 28, 'episodes_per_condition': 20,
