...
This is the README preserved before the public academic release of 21 September 2026. Dated status, private-repository descriptions and next-action instructions below are historical. Start with the current [README](README.md) and [report](publication/academic_report.pdf).

# Neural Scaling of the Drosophila Connectome

## Current status - local academic report complete, 2026-09-21

The [publication package](publication/README.md) contains the finished 13-page [academic report](publication/academic_report.pdf), six-page [technical supplement](publication/technical_supplement.pdf), three vector figures, editable sources, evidence and reproducibility records. The requested report date remains 16 September 2026. [Production readiness](publication/readiness.md) separates completed checks from author approval, declarations and outside scientific review. Forty-three paired-summary checks, 380 saved-array/summary checks and the versioned schema-3 repository validator passed. No new training, confirmation sample, submission, publication or push occurred.

The next action is author and independent scientific review of this focused report. This production status supersedes the historical preparation handoffs below without changing their experimental results.
